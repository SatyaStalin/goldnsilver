...
const FEATURES = [
  { title: '999+ purity silver', icon: 'purity' },
  { title: 'Tamper-proof Packaging', icon: 'pack' },
  { title: 'Insured Delivery', icon: 'ship' }
];

const WHY_POINTS = [
  { title: 'Trusted Purity', text: 'BIS-hallmarked silver with certified fineness.' },
...
function mergeCatalog(productArrays) {
  ...
  const order = { silver: 0, 'gold+silver': 1, gold: 2 };
  ...
  return (
    <div className="gs-page ogd-page">
      <header className="ogd-page-title gs-section">
        ...
        <h1>Physical Silver Products – GoldnSilver.shop</h1>
        <img src={mmtcAssets.titleRight} alt="" className="ogd-title-ornament" />
      </header>

      <section className="gs-section ogd-hero-wrap" aria-label="GoldnSilver physical silver products">
        <div className="ogd-hero">
          <div className="ogd-hero-copy">
            <div className="ogd-hero-brand">
              <span>
                GoldnSilver.shop
                <small>Silver branded products</small>
              </span>
            </div>
            <p className="ogd-hero-body">
              Access a wide range of 999+ pure silver products from GoldnSilver.shop — India&apos;s
            ...
            <div className="ogd-hero-actions">
              <button type="button" className="ogd-cta ogd-cta--gold" onClick={() => scrollToShop('silver')}>
                Shop Silver
              </button>
              <button type="button" className="ogd-cta ogd-cta--navy" onClick={() => scrollToShop('gold')}>
                Shop Gold
              </button>
            </div>
          </div>
      ...
      <section className="gs-section ogd-shop" id="ogd-shop">
        <div className="ogd-shop-head">
          ...
          <h2>Silver Products – GoldnSilver.shop</h2>
          <span className="ogd-shop-diamond" aria-hidden="true" />
        </div>
      ...
      <section className="gs-section ogd-info-wrap">
        <div className="ogd-info">
          <h2>Our Story</h2>
          <p>
            GoldnSilver.shop brings certified physical silver to your doorstep with transparent
          ...
          <h3>Buy Silver Online with Confidence</h3>
          <p>
            From coins and bars to festive sets, shop physical silver online with live rates, secure
      ...
      <div className="ogd-footer-cta gs-section">
        ...
        <Link to="/own-gold" className="ogd-cta ogd-cta--navy">
          Browse Gold
        </Link>
      </div>
